...
public class ChooseYourOwnAdventure2
{
  ...
  private static void approachOoze()
  {
    ...
    if (MessageBox.askForTextInput("Do you want to pour the ooze into the 'backyard' or 'toilet'?") == "toilet")
    {
      pourIntoToilet();
    }
    else if (MessageBox
        .askForTextInput("Do you want to pour the ooze into the 'backyard' or 'toilet'?") == "backyard")
    {
  ...
  private static void pourIntoToilet()
  {
    ...
    if (MessageBox.askForTextInput("Do you want to train to be a NINJA?  'Yes' or 'HECK YES'?") == "yes")
    {
      MessageBox
          .showMessage("Awesome dude!  You live out the rest of your life fighting crimes and eating pizza!");
    }
    else if (MessageBox.askForTextInput("Do you want to train to be a NINJA?  'Yes' or 'HECK YES'?") == "heck yes")
    {
      MessageBox
          .showMessage("Awesome dude!  You live out the rest of your life fighting crimes and eating pizza!");
    }
