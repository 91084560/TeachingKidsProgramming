...
public class DeepDive03Ifs
{
  ...
  {
    boolean explore;
    String answer = MessageBox.askForTextInput("Do you want to 'wake up' or 'explore' the dream?");
    if (answer.equalsIgnoreCase("explore"))
    {
      explore = true;
    }
    else
  ...
  public void cyoaIncorrectInputTest() throws Exception
  {
    boolean explore;
    String answer = MessageBox.askForTextInput("Do you want to 'wake up' or 'explore' the dream?");
    if (answer.equalsIgnoreCase("explore") || answer.equalsIgnoreCase("wake up"))
    {
      explore = true;
    }
    else
  ...
  @Test
  public void thereMustBeSevenDwarfs() throws Exception
  {
    int dwarfs = 7;
    boolean apple;
    if (dwarfs != 7)
    ...
    Assert.assertEquals(true, apple);
  }
  @Test
  public void neverFails() throws Exception
  {
    ...
    String maybe;
    if (eitherWay == true || eitherWay == false)
    {
      maybe = "forever";
    }
    else
    ...
    Assert.assertEquals(maybe, "forever");
  }
  /**
